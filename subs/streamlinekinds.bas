sub StreamlineKinds()
 ...
 for i as Integer = 1 to itemlist.Length()
  ...
  'elseif link->universal then
   ...
   select case link->kind
    ...
    case "Star":      link->itemdata.equip_code = 13
    case "Boomerang": link->itemdata.equip_code = 14
    case "Harp":      link->itemdata.equip_code = 15
    case "Hammer":    link->itemdata.equip_code = 16
    case "Bow":       link->itemdata.equip_code = 17
    case "Arrow":     link->itemdata.equip_code = 17
    case "Shield":    link->itemdata.equip_code = 18
    case "Helm":      link->itemdata.equip_code = 19
    case "Hat":       link->itemdata.equip_code = 20
    case "Mail":      link->itemdata.equip_code = 21
    case "Vest":      link->itemdata.equip_code = 22
    case "Robe":      link->itemdata.equip_code = 23
    case "Gauntlet":  link->itemdata.equip_code = 24
    case "Ring":      link->itemdata.equip_code = 25
   end select
  end if
 next
 ...
 ff4.equipcharts(14).flags(ninja_job) = true
 
 ff4.equipcharts(15).flags(bard_job) = true
 
 ff4.equipcharts(16).flags(chief_job) = true
 
 ff4.equipcharts(17).flags(young_caller_job) = true
 ff4.equipcharts(17).flags(bard_job) = true
 ff4.equipcharts(17).flags(archer_job) = true
 ff4.equipcharts(17).flags(black_wiz_job) = true
 ff4.equipcharts(17).flags(white_wiz_job) = true
 ff4.equipcharts(17).flags(paladin_job) = true
 ff4.equipcharts(17).flags(chief_job) = true
 ff4.equipcharts(17).flags(adult_caller_job) = true
 ff4.equipcharts(17).flags(lunar_job) = true
 ...
 ff4.equipcharts(19).flags(dragoon_job) = true
 ff4.equipcharts(19).flags(paladin_job) = true
 ff4.equipcharts(19).flags(chief_job) = true

 for i as Integer = 0 to usable_jobs 
  ff4.equipcharts(20).flags(i) = true
 next
 
 ff4.equipcharts(21).flags(dragoon_job) = true
 ff4.equipcharts(21).flags(paladin_job) = true
 ff4.equipcharts(21).flags(chief_job) = true
 
 for i as Integer = 0 to usable_jobs 
  ff4.equipcharts(22).flags(i) = true
 next
 
 ff4.equipcharts(23).flags(young_caller_job) = true
 ff4.equipcharts(23).flags(sage_job) = true
 ff4.equipcharts(23).flags(archer_job) = true
 ff4.equipcharts(23).flags(black_wiz_job) = true
 ff4.equipcharts(23).flags(white_wiz_job) = true
 ff4.equipcharts(23).flags(paladin_job) = true
 ff4.equipcharts(23).flags(adult_caller_job) = true
 ff4.equipcharts(23).flags(lunar_job) = true
 
 ff4.equipcharts(24).flags(dragoon_job) = true
 ff4.equipcharts(24).flags(paladin_job) = true
 ff4.equipcharts(24).flags(chief_job) = true
 ff4.equipcharts(24).flags(ninja_job) = true
 
 for i as Integer = 0 to usable_jobs 
  ff4.equipcharts(25).flags(i) = true
 next
