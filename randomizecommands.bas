sub RandomizeCommands()
 ...
 ff4.jobs(adult_caller_job).white = ff4.jobs(young_caller_job).white
 ff4.jobs(adult_caller_job).black = ff4.jobs(young_caller_job).black
 ff4.jobs(adult_caller_job).summon = ff4.jobs(young_caller_job).summon
 ff4.jobs(adult_caller_job).menu_white = ff4.jobs(young_caller_job).menu_white
 ff4.jobs(adult_caller_job).menu_black = ff4.jobs(young_caller_job).menu_black
 ff4.jobs(adult_caller_job).menu_summon = ff4.jobs(young_caller_job).menu_summon

 for i as Integer = 0 to total_actors
  if ff4.actors(i).load_initial then actors.AddSide(chr(i))
 next
  ...
  if ff4.CommandCount(current_actor) = 5 then
   ...
   if RollDie(4) > 1 or ff4.CommandCount(current_actor) < 3 then
    ...
    if current_command = hide_command or current_command = cover_command then
     if ff4.UniqueActor(current_actor) then
